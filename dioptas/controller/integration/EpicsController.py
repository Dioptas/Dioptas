...
class EpicsController(object):
    ...
    def update_image_position(self):
        try:
            self.move_widget.img_hor_lbl.setText('{:.3f}'.format(self.model.img_model.state.motors_info['Horizontal']))
            self.move_widget.img_ver_lbl.setText('{:.3f}'.format(self.model.img_model.state.motors_info['Vertical']))
            self.move_widget.img_focus_lbl.setText('{:.3f}'.format(self.model.img_model.state.motors_info['Focus']))
            self.move_widget.img_omega_lbl.setText('{:.3f}'.format(self.model.img_model.state.motors_info['Omega']))
        except KeyError:

...
class MaskController(object):
    ...
    def below_thresh_btn_click(self):
        ...
        self.model.mask_model.mask_below_threshold(self.model.img_model.img_data, thresh)
        self.plot_mask()

    def above_thresh_btn_click(self):
        thresh = np.float64(self.widget.above_thresh_txt.text())
        self.model.mask_model.mask_above_threshold(self.model.img_model.img_data, thresh)
        self.plot_mask()
    ...
    def cosmic_btn_click(self):
        self.model.mask_model.remove_cosmic(self.model.img_model.img_data)
        self.plot_mask()

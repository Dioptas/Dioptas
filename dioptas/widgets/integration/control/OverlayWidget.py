...
class OverlayWidget(QtWidgets.QWidget):
    ...
    def add_overlay(self, name, color):
        ...
        show_cb_widget = QtWidgets.QWidget()
        show_cb_widget.setStyleSheet('background: transparent')
        show_cb_layout = QtWidgets.QHBoxLayout()
        show_cb_layout.setContentsMargins(5, 3, 3, 0)
        show_cb_layout.addWidget(show_cb)
        show_cb_widget.setLayout(show_cb_layout)
        self.overlay_tw.setCellWidget(current_rows, 0, show_cb_widget)

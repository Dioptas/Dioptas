...
class Ui_XrsCalibrationWidget(object):
    def setupUi(self, XrsCalibrationWidget):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 250, 199))
        ...
        self.horizontalLayout_10.addWidget(self.automatic_peak_search_rb)
        self.select_peak_rb = QtGui.QRadioButton(self.page)
        self.select_peak_rb.setObjectName(_fromUtf8("select_peak_rb"))
        self.horizontalLayout_10.addWidget(self.select_peak_rb)
        ...
        self.pyFAI.setGeometry(QtCore.QRect(0, 0, 161, 299))
    ...
    def retranslateUi(self, XrsCalibrationWidget):
        ...
        self.automatic_peak_search_rb.setText(_translate("XrsCalibrationWidget", "automatic search", None))
        self.select_peak_rb.setText(_translate("XrsCalibrationWidget", "select peak", None))

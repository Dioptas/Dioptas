...
# Form implementation generated from reading ui file 'XrsIntegration.ui'
#
...
class Ui_xrs_integration_widget(object):
    def setupUi(self, xrs_integration_widget):
        ...
        xrs_integration_widget.resize(853, 506)
        self.horizontalLayout_13 = QtGui.QHBoxLayout(xrs_integration_widget)
        self.horizontalLayout_13.setMargin(5)
        ...
        self.horizontalLayout_12.addWidget(self.x_lbl)
        self.y_lbl = QtGui.QLabel(self.layoutWidget)
        self.y_lbl.setObjectName(_fromUtf8("y_lbl"))
        self.horizontalLayout_12.addWidget(self.y_lbl)
        ...
        self.horizontalLayout_12.addWidget(self.q_lbl)
        ...
        self.load_img_btn.setMaximumSize(QtCore.QSize(75, 16777215))
        ...
        self.autoproces_cb = QtGui.QCheckBox(self.image_tab)
        self.autoproces_cb.setObjectName(_fromUtf8("autoproces_cb"))
        self.horizontalLayout_10.addWidget(self.autoproces_cb)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_10.addItem(spacerItem)
        self.label_8 = QtGui.QLabel(self.image_tab)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.horizontalLayout_10.addWidget(self.label_8)
        self.img_browse_by_name_rb = QtGui.QRadioButton(self.image_tab)
        self.img_browse_by_name_rb.setChecked(True)
        self.img_browse_by_name_rb.setObjectName(_fromUtf8("img_browse_by_name_rb"))
        self.horizontalLayout_10.addWidget(self.img_browse_by_name_rb)
        self.img_browse_by_date_rb = QtGui.QRadioButton(self.image_tab)
        self.img_browse_by_date_rb.setObjectName(_fromUtf8("img_browse_by_date_rb"))
        self.horizontalLayout_10.addWidget(self.img_browse_by_date_rb)
        ...
        self.mask_show_cb = QtGui.QCheckBox(self.groupBox)
        self.mask_show_cb.setObjectName(_fromUtf8("mask_show_cb"))
        self.horizontalLayout_14.addWidget(self.mask_show_cb)
        ...
        self.load_spectrum_btn = QtGui.QPushButton(self.spectra_tab)
        self.load_spectrum_btn.setMinimumSize(QtCore.QSize(75, 0))
        self.load_spectrum_btn.setMaximumSize(QtCore.QSize(75, 16777215))
        self.load_spectrum_btn.setObjectName(_fromUtf8("load_spectrum_btn"))
        self.horizontalLayout_4.addWidget(self.load_spectrum_btn)
        self.previous_spec_btn = QtGui.QPushButton(self.spectra_tab)
        self.previous_spec_btn.setMinimumSize(QtCore.QSize(10, 0))
        self.previous_spec_btn.setMaximumSize(QtCore.QSize(50, 16777215))
        self.previous_spec_btn.setObjectName(_fromUtf8("previous_spec_btn"))
        self.horizontalLayout_4.addWidget(self.previous_spec_btn)
        self.next_spec_btn = QtGui.QPushButton(self.spectra_tab)
        self.next_spec_btn.setMaximumSize(QtCore.QSize(50, 16777215))
        self.next_spec_btn.setObjectName(_fromUtf8("next_spec_btn"))
        self.horizontalLayout_4.addWidget(self.next_spec_btn)
        ...
        self.autocreate_spec_cb = QtGui.QCheckBox(self.spectra_tab)
        self.autocreate_spec_cb.setChecked(True)
        self.autocreate_spec_cb.setObjectName(_fromUtf8("autocreate_spec_cb"))
        self.horizontalLayout_11.addWidget(self.autocreate_spec_cb)
        ...
        self.spec_browse_by_date_rb = QtGui.QRadioButton(self.spectra_tab)
        self.spec_browse_by_date_rb.setObjectName(_fromUtf8("spec_browse_by_date_rb"))
        self.horizontalLayout_11.addWidget(self.spec_browse_by_date_rb)
        ...
        self.phase_temperature_step.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.horizontalLayout_13.addWidget(self.horizontal_splitter)
    ...
    def retranslateUi(self, xrs_integration_widget):
        ...
        self.label_8.setText(_translate("xrs_integration_widget", "Browse: ", None))
        self.img_browse_by_name_rb.setText(_translate("xrs_integration_widget", "By Name", None))
        self.img_browse_by_date_rb.setText(_translate("xrs_integration_widget", "By Date", None))
        self.groupBox.setTitle(_translate("xrs_integration_widget", "Mask", None))
        self.mask_show_cb.setText(_translate("xrs_integration_widget", "Show", None))
        ...
        self.load_spectrum_btn.setText(_translate("xrs_integration_widget", "Load", None))
        self.previous_spec_btn.setText(_translate("xrs_integration_widget", "<", None))
        self.next_spec_btn.setText(_translate("xrs_integration_widget", ">", None))
        ...
        self.autocreate_spec_cb.setText(_translate("xrs_integration_widget", "autocreate", None))
        ...
        self.spec_browse_by_date_rb.setText(_translate("xrs_integration_widget", "By Date", None))

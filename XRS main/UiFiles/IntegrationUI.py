...
class Ui_xrs_integration_widget(object):
    def setupUi(self, xrs_integration_widget):
        ...
        self.widget = QtGui.QWidget(self.horizontal_splitter)
        ...
        self.img_pg_layout = GraphicsLayoutWidget(self.widget)
        ...
        self.x_lbl = QtGui.QLabel(self.widget)
        ...
        self.y_lbl = QtGui.QLabel(self.widget)
        ...
        self.int_lbl = QtGui.QLabel(self.widget)
        ...
        self.two_theta_lbl = QtGui.QLabel(self.widget)
        ...
        self.d_lbl = QtGui.QLabel(self.widget)
        ...
        self.q_lbl = QtGui.QLabel(self.widget)
        ...
        self.img_browse_by_date_rb = QtGui.QRadioButton(self.groupBox)
        self.img_browse_by_date_rb.setObjectName(_fromUtf8("img_browse_by_date_rb"))
        self.gridLayout_4.addWidget(self.img_browse_by_date_rb, 0, 1, 1, 1)
        ...
        self.mask_show_cb = QtGui.QCheckBox(self.groupBox1)
        self.mask_show_cb.setChecked(True)

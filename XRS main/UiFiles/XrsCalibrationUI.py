...
class Ui_XrsCalibrationWidget(object):
    def setupUi(self, XrsCalibrationWidget):
        ...
        self.horizontalLayout_9 = QtGui.QHBoxLayout(XrsCalibrationWidget)
        ...
        self.horizontalLayout_3 = QtGui.QHBoxLayout(self.image_tab)
        self.horizontalLayout_3.setMargin(0)
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.widget1 = QtGui.QWidget(self.image_tab)
        self.widget1.setObjectName(_fromUtf8("widget1"))
        self.horizontalLayout_10 = QtGui.QHBoxLayout(self.widget1)
        self.horizontalLayout_10.setMargin(0)
        self.horizontalLayout_10.setObjectName(_fromUtf8("horizontalLayout_10"))
        self.img_pg_layout = GraphicsLayoutWidget(self.widget1)
        ...
        self.horizontalLayout_10.addWidget(self.img_pg_layout)
        self.horizontalLayout_3.addWidget(self.widget1)
        self.tab_widget.addTab(self.image_tab, _fromUtf8(""))
        self.spectrum_tab = QtGui.QWidget()
        self.spectrum_tab.setObjectName(_fromUtf8("spectrum_tab"))
        self.horizontalLayout_14 = QtGui.QHBoxLayout(self.spectrum_tab)
        self.horizontalLayout_14.setMargin(0)
        self.horizontalLayout_14.setObjectName(_fromUtf8("horizontalLayout_14"))
        self.widget_2 = QtGui.QWidget(self.spectrum_tab)
        self.widget_2.setObjectName(_fromUtf8("widget_2"))
        self.horizontalLayout_13 = QtGui.QHBoxLayout(self.widget_2)
        self.horizontalLayout_13.setMargin(0)
        self.horizontalLayout_13.setObjectName(_fromUtf8("horizontalLayout_13"))
        self.cake_pg_layout = GraphicsLayoutWidget(self.widget_2)
        self.cake_pg_layout.setObjectName(_fromUtf8("cake_pg_layout"))
        self.horizontalLayout_13.addWidget(self.cake_pg_layout)
        self.horizontalLayout_14.addWidget(self.widget_2)
        self.tab_widget.addTab(self.spectrum_tab, _fromUtf8(""))
        self.spectrum_tab1 = QtGui.QWidget()
        self.spectrum_tab1.setObjectName(_fromUtf8("spectrum_tab1"))
        self.horizontalLayout_8 = QtGui.QHBoxLayout(self.spectrum_tab1)
        self.horizontalLayout_8.setMargin(0)
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.spectrum_pg_layout = GraphicsLayoutWidget(self.spectrum_tab1)
        self.spectrum_pg_layout.setObjectName(_fromUtf8("spectrum_pg_layout"))
        self.horizontalLayout_8.addWidget(self.spectrum_pg_layout)
        self.tab_widget.addTab(self.spectrum_tab1, _fromUtf8(""))
        ...
        self.load_file_btn = QtGui.QPushButton(self.widget2)
        ...
        self.filename_lbl = QtGui.QLabel(self.widget2)
        ...
        self.ToolBox = QtGui.QToolBox(self.widget2)
        self.ToolBox.setObjectName(_fromUtf8("ToolBox"))
        self.toolBoxPage1 = QtGui.QWidget()
        self.toolBoxPage1.setGeometry(QtCore.QRect(0, 0, 453, 438))
        ...
        self.pyFAI.setGeometry(QtCore.QRect(0, 0, 453, 438))
        self.pyFAI.setObjectName(_fromUtf8("pyFAI"))
        self.gridLayout_7 = QtGui.QGridLayout(self.pyFAI)
        ...
        self.gridLayout_7.addWidget(self.pf_distance_txt, 0, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_distance_cb, 0, 3, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_wavelength_txt, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_wavelength_cb, 1, 3, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_poni1_txt, 2, 1, 1, 1)
        self.label_29 = QtGui.QLabel(self.pyFAI)
        self.label_29.setObjectName(_fromUtf8("label_29"))
        self.gridLayout_7.addWidget(self.label_29, 2, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_poni2_txt, 3, 1, 1, 1)
        self.label_30 = QtGui.QLabel(self.pyFAI)
        self.label_30.setObjectName(_fromUtf8("label_30"))
        self.gridLayout_7.addWidget(self.label_30, 3, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_rotation1_txt, 4, 1, 1, 1)
        self.label_31 = QtGui.QLabel(self.pyFAI)
        self.label_31.setObjectName(_fromUtf8("label_31"))
        self.gridLayout_7.addWidget(self.label_31, 4, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_rotation2_txt, 5, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_rotation3_txt, 6, 1, 1, 1)
        self.label_33 = QtGui.QLabel(self.pyFAI)
        self.label_33.setObjectName(_fromUtf8("label_33"))
        self.gridLayout_7.addWidget(self.label_33, 6, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_pixel_width_txt, 7, 1, 1, 1)
        self.label_11 = QtGui.QLabel(self.pyFAI)
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.gridLayout_7.addWidget(self.label_11, 7, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_47, 8, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pf_pixel_height_txt, 8, 1, 1, 1)
        self.label_12 = QtGui.QLabel(self.pyFAI)
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.gridLayout_7.addWidget(self.label_12, 8, 2, 1, 1)
        ...
        self.horizontalLayout_18.addWidget(self.pf_update_btn)
        self.gridLayout_7.addLayout(self.horizontalLayout_18, 9, 0, 1, 3)
        ...
        self.toolBoxPage3.setGeometry(QtCore.QRect(0, 0, 453, 438))
        self.toolBoxPage3.setObjectName(_fromUtf8("toolBoxPage3"))
        self.gridLayout_3 = QtGui.QGridLayout(self.toolBoxPage3)
        ...
        self.gridLayout_3.addWidget(self.f2_distance_txt, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.f2_rotation_txt, 4, 1, 1, 1)
        self.label_44 = QtGui.QLabel(self.toolBoxPage3)
        self.label_44.setObjectName(_fromUtf8("label_44"))
        self.gridLayout_3.addWidget(self.label_44, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.f2_tilt_txt, 5, 1, 1, 1)
        self.label_43 = QtGui.QLabel(self.toolBoxPage3)
        self.label_43.setObjectName(_fromUtf8("label_43"))
        self.gridLayout_3.addWidget(self.label_43, 5, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.f2_pixel_width_txt, 6, 1, 1, 1)
        self.label_77 = QtGui.QLabel(self.toolBoxPage3)
        self.label_77.setObjectName(_fromUtf8("label_77"))
        self.gridLayout_3.addWidget(self.label_77, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_75, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.f2_pixel_height_txt, 7, 1, 1, 1)
        self.label_76 = QtGui.QLabel(self.toolBoxPage3)
        self.label_76.setObjectName(_fromUtf8("label_76"))
        self.gridLayout_3.addWidget(self.label_76, 7, 2, 1, 1)
        ...
        self.horizontalLayout_17.addWidget(self.f2_update_btn)
        self.gridLayout_3.addLayout(self.horizontalLayout_17, 8, 0, 1, 3)
        spacerItem8 = QtGui.QSpacerItem(20, 147, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem8, 9, 1, 1, 1)
        self.ToolBox.addItem(self.toolBoxPage3, _fromUtf8(""))
        self.verticalLayout_4.addWidget(self.ToolBox)
        self.horizontalLayout = QtGui.QHBoxLayout()
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.load_calibration_btn = QtGui.QPushButton(self.widget2)
        ...
        self.save_calibration_btn = QtGui.QPushButton(self.widget2)
        ...
        XrsCalibrationWidget.setTabOrder(self.save_calibration_btn, self.img_pg_layout)

    def retranslateUi(self, XrsCalibrationWidget):
        XrsCalibrationWidget.setWindowTitle(_translate("XrsCalibrationWidget", "Form", None))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.image_tab), _translate("XrsCalibrationWidget", "Image", None))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.spectrum_tab), _translate("XrsCalibrationWidget", "Cake", None))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.spectrum_tab1), _translate("XrsCalibrationWidget", "Spectrum", None))
        ...
        self.ToolBox.setItemText(self.ToolBox.indexOf(self.toolBoxPage1), _translate("XrsCalibrationWidget", "Start Values", None))
        ...
        self.ToolBox.setItemText(self.ToolBox.indexOf(self.page), _translate("XrsCalibrationWidget", "Peakpicker", None))
        ...
        self.ToolBox.setItemText(self.ToolBox.indexOf(self.pyFAI), _translate("XrsCalibrationWidget", "pyFAI Calibration", None))
        ...
        self.ToolBox.setItemText(self.ToolBox.indexOf(self.toolBoxPage3), _translate("XrsCalibrationWidget", "Fit2D Calibration", None))

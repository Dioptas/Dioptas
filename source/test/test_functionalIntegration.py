...
class IntegrationFunctionalTest(unittest.TestCase):
    def setUp(self):
        ...
        self.calibration_model = self.main_controller.calibration_data
        self.img_model = self.main_controller.img_data
        self.mask_model = self.main_controller.mask_data

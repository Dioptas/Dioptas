...
def test_phases(controller):
    ...
    controller.integration_controller.phase_controller.add_btn_click_callback('ExampleData/jcpds/dac_user/au_Anderson.jcpds')
    controller.integration_controller.phase_controller.add_btn_click_callback('ExampleData/jcpds/dac_user/au_Jamieson.jcpds')
    controller.integration_controller.phase_controller.add_btn_click_callback('ExampleData/jcpds/dac_user/ar.jcpds')
    controller.integration_controller.phase_controller.add_btn_click_callback('ExampleData/jcpds/dac_user/fe-hcp.jcpds')

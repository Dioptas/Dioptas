...
"}"))
        ...
        self.gridLayout_4.addWidget(self.automatic_binning_cb, 0, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.bin_count_txt, 1, 1, 1, 1)
    ...
    def retranslateUi(self, xrs_integration_widget):
        ...
        self.automatic_binning_cb.setText(_translate("xrs_integration_widget", "Automatic estimation of number of bins", None))
